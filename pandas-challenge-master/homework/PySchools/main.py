...
disgustingASCII = '''
            ...
            o      O       o             O               O.             o                 o
            O     .o       o            oOo               `OOoo.        O                 O
            oOooOO'  O   o o         O   o   O   o             `O .oOo  OoOo. .oOo. .oOo. o  .oOo
            o        o   O O         o   O   o   O              o O     o   o O   o O   o O  `Ooo.
            O        O   o `o     .o O   o   O   o       O.    .O o     o   O o   O o   O o      O
            o'       `OoOO  `OoooO'  o'  `oO `OoOO        `oooO'  `OoO' O   o `OoO' `OoO' Oo `OoO'
                         o                       o
                      OoO'                    OoO'
'''
...
def Again():
    ...
    print(lineSep + "\n")
    againANS = str(input(
        f"{color.BOLD}Would you like to generate a new report? {color.RED}[y/n]: {color.END}"))
    if againANS == "y":
        return "y"
    else:
        return None
...
def ChoicePrompt():
    print(
        f"{color.BOLD}{color.UNDERLINE}\nChoices of reports to generate:{color.END}\n\n• District Summary                            {color.RED}[1]{color.END}")
    print(
        f"• Top Performing Schools (By Passing Rate)    {color.RED}[2]{color.END}")
    print(
        f"• Bottom Performing Schools (By Passing Rate) {color.RED}[3]{color.END}")
    print(
        f"• Math Scores by Grade                        {color.RED}[4]{color.END}")
    print(
        f"• Reading Scores by Grade                     {color.RED}[5]{color.END}")
    print(
        f"• Scores by School Spending                   {color.RED}[6]{color.END}")
    print(f"• Scores by School Size                       {color.RED}[7]{color.END}")
    print(f"• Scores by School Type                       {color.RED}[8]{color.END}")
    print(
    ...
    if ans == 1:
        ...
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '         District Summary:           ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(DistrictSummaryDF.to_string(index=False))
        time.sleep(1)
    elif ans == 2:
        print("\n" + lineSep)
        print(color.RED + '+*******************************| ' + color.END + color.BOLD +
              ' Top Performing Schools (By Passing Rate): ' + color.END + color.RED + ' |*********************************+' + color.END)
        print(lineSep + "\n")
        print(sortingDF_TOP_5.to_string(index=False))
        time.sleep(1)
    elif ans == 3:
        print("\n" + lineSep)
        print(color.RED + '+******************************| ' + color.END + color.BOLD +
              ' Bottom Performing Schools (By Passing Rate): ' + color.END + color.RED + ' |*******************************+' + color.END)
        print(lineSep + "\n")
        print(sortingDF_BOTTOM_5.to_string(index=False))
        time.sleep(1)
    elif ans == 4:
        print("\n" + lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '         Math Scores by Grade:       ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(AllSchoolsMath_byGrade.to_string(index=True))
        time.sleep(1)
    elif ans == 5:
        print("\n" + lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '       Reading Scores by Grade:      ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(AllSchoolsReading_byGrade.to_string(index=False))
        time.sleep(1)
    elif ans == 6:
        print("\n" + lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '      Scores by School Spending:     ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(SpendersSummaryDF.to_string(index=False))
        time.sleep(1)
    elif ans == 7:
        print("\n" + lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '        Scores by School Size:       ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(SizeSummaryDF.to_string(index=False))
        time.sleep(1)
    elif ans == 8:
        print("\n" + lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '        Scores by School Type:       ' + color.END + color.RED + ' |************************************+' + color.END)
        print(lineSep + "\n")
        print(TypeSummaryDF.to_string(index=False))
    elif ans == 9:
        print(lineSep)
        print(color.RED + '+**********************************| ' + color.END + color.BOLD +
              '         District Summary:           ' + color.END + color.RED + ' |************************************+' + color.END)
        ...
        print(f"Your input of {ans} as not a valid option")
#*MAIN
PrintWelcome()
while Again() == "y":
    ChoicePrompt()
